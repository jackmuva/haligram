...
"[project]/.next-internal/server/app/(reddit)/api/reddit/check-auth/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/(reddit)/api/reddit/check-auth/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const hasToken = (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$queries$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRedditTokenByEmail"])(user[0].email)).length === 0 ? false : true;
    return Response.json({
        hasAuth: hasToken
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__493d98d8._.js.map